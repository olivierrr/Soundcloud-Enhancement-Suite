    angular.module('SESApp')
        .factory('friendsService', ['$http', '$timeout', '$q', 'Soundcloud',
            function($http, $timeout, $q, Soundcloud) {
                ...
                /**
                 * Request users in the friends list.
                 */
                function getFriends(offset, userId) {
                 ...
                 * so we need to call getFriends multiple times.
                 */
                function buildList(userId, count) {
                    ...
                    while (i <= count) {
                        promises.push(getFriends(i, userId).then(mapUsers)
                            );
                        i += 200;
                    }
                 ...
                 * which creates a bunch of promises that are resolved when getFriends
